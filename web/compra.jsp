...
<body class="container">
    ...
    <h2 class="my-4">Registrar Nueva Compra</h2>
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
    <form action="sr_compra" method="POST">
        <!-- Información de la venta -->
        <input type="hidden" name="action" value="create">

        <h3 class="mb-4">Información de Compra</h3>
        <div class="mb-3">
       ...
       <br>
        ...
        <h3 class="mb-4">Detalles de Compra</h3>
            ...
            <table id="detallesTabla" class="table table-bordered table-hover w-auto">
                <thead class="table-info">
                    <tr>
                        ...
                        <th class="text-center">Precio Costo Unitario</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center"><input type="text" name="precio_costo_unitario1" class="form-control" required></td>
        ...
        <button type="submit" class="btn btn-primary btn-lg">Guardar Compra</button>
    </form>
    </div>
